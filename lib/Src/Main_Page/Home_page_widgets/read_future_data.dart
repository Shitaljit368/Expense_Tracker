...
class ReadFutureDataPage extends StatefulWidget {
  const ReadFutureDataPage({super.key});

  @override
  State<ReadFutureDataPage> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<ReadFutureDataPage> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context,
        ...
        var d = data["future_plans"] as List;
        log("test $d");
